(defproject hot-dice "0.1.0-SNAPSHOT"
  ...
  :ring {:handler hot-dice.handler/app
         :uberwar-name "hot-dice.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "hot-dice.jar"

  :main hot-dice.server
  ...
  :profiles {:dev {:repl-options {:init-ns hot-dice.repl}
